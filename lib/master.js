...
function Master(config) {
    ...
    var accessLogger = new AccessLogger(config.server.accessLog);
    var errorLogger = new AccessLogger(config.server.errorLog);
    ...
    this.accessLog = accessLogger.log;
    this.errorLog = errorLogger.log;
}
