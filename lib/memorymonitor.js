...
function MemoryMonitor(options) {
    ...
    this.log = function (msg) {
      this.options.logger.info('MemoryMonitor: ' + msg);
    };
    this.warn = function(msg) {
      this.options.logger.warn('MemoryMonitor: ' + msg);      
    }
...
MemoryMonitor.prototype.tick = function () {
    ...
    this.warn('Memory limit exceeded (' + Math.round(currentMemory / (1024 * 1024)) + 'MB), exiting...');
    this.exit();
};
